...
<?php
  ...
  if(!empty($_POST)) {
    ...
    $redirect = get_site_url(null, "/proposition");
...
<p class="path" style="cursor:pointer">
  ...
  <span class="pathelt"> Proposer une pièce</span></p>
    <form action="<?php the_permalink();?>" enctype="multipart/form-data" method="post">
        <section id="announcement">
            <h1>Votre proposition pour :</h1>
            <p id="titleP"><?php echo $_SERVER['HTTP_REFERER']; ?></p>

            <h2>Type de proposition*</h2>
            ...
            <p><label for="descriptif" class="labelSelect">Votre message</label></p>
            <p id="textareaP"><textarea placeholder="Saisissez votre message" name="message" id="counter" maxlength="1000" ></textarea><span id="compteur">1000</span></p>
        ...
        <section id="info">
            ...
            <div id="companyAndName">
                <div id="name">
                    <p><label for="name">Nom* <span>Ne sera pas communiqué à l'acheteur</span></label></p>
                    <p><input type="text" id="lastname" name="lastname" required/></p>
                </div>
                <div id="name">
                    <p><label for="name">Prénom* <span>Ne sera pas communiqué à l'acheteur</span></label></p>
                    <p><input type="text" id="firstname" name="firstname" required/></p>
                </div>
            </div>

            <div id="company">
                    <p><label for="company">Société <span>(facultatif, ne sera pas communiqué à l'acheteur)</span></label></p>
                    <p><input type="text" name="society" id="company" /></p>
                </div>

            <p><label for="mail">Adresse* <span>Ne sera pas communiqué à l'acheteur</span></label></p>
            ...
            <p><label for="mail">Email* <span>Votre adresse mail ne sera pas communiquée à l'acheteur</span></label></p>
            <p><input type="mail" name="email" id="mail" required/></p>
            <p><label for="tel">Téléphone* <span>Votre numéro de téléphone ne sera pas communiqué à l'acheteur</span></label></p>
            <p><input type="tel" id="tel" name="phone" required/></p>
        </section>
        <p id="buttonP"><span>* Champs obligatoires</span><button type="submit">Envoyer ma proposition</button></p>
    </form>
    <div id="announcement__validation" class="<?php if($_GET['v'] == "1"){ echo "active"; } ?>">
      ...
      <div class="announcement__validation--container">
        ...
        <p>Votre proposition sera relue par notre équipe éditoriale pour envoi au demandeur. Une fois votre proposition envoyée, le demandeur a un délai de 48h maximum pour accepter ou non.</p>
        <p>En cas de refus de votre proposition par l’équipe éditoriale, vous recevrez un mail vous expliquant les motifs du refus.</p>
